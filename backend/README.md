...
## Project Structure
    ...
    ├── lucky_limit_dev_121710  # Django project configurations
...
1. Clone this repo and `cd lucky_limit_dev_121710`
...
2. Clone this repo and `cd lucky_limit_dev_121710`
