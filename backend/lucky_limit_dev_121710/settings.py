"""
Django settings for lucky_limit_dev_121710 project.
...
ROOT_URLCONF = 'lucky_limit_dev_121710.urls'
...
WSGI_APPLICATION = 'lucky_limit_dev_121710.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lucky_limit_dev_121710 API",
    "DESCRIPTION": "API documentation for lucky_limit_dev_121710 App",
    "VERSION": "v1",
}
